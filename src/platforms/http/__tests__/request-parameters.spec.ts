...
describe('HTTP Platform Request Parameters', () => {
  ...
  runPlatformTest('should handle array query parameters', async (platform: HttpPlatform) => {
    ...
    expect(response1.body.params.items).toEqual(['1', '2', '3']);
    ...
    expect(response2.body.params.items).toEqual(['3', '2', '1']);
  });
  ...
  runPlatformTest('should handle multi-layer optional parameters', async (platform: HttpPlatform) => {
    // Define routes with optional parameters at different levels
    ...
    expect(response2a.body).toEqual({
      version: 'v1',
      userId: '123',
      postId: '456',
      query: { status: 'draft' }
    ...
    expect(response3a.body).toEqual({
      version: 'v2',
      userId: 'all',
      postId: '456',
